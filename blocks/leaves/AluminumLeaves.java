...
public class AluminumLeaves extends BlockLeaves implements IHasModel
{
	public static String type;
	
	public AluminumLeaves(String name) 
	{
	...
	{
		 Item.getItemFromBlock(ModBlocks.ALUMINUM_SAPLING);
		
		return Item.getItemFromBlock(ModBlocks.ALUMINUM_SAPLING);
	}
	*/
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.ALUMINUM_PINECONE, RANDOM.nextInt(6)+-4));
			if(RANDOM.nextFloat()>0.7f) {
				drops.add(new ItemStack(BlockInit.ALUMINUM_SAPLING, RANDOM.nextInt(6)+-4));
	...
	@Override
	protected int getSaplingDropChance(IBlockState state) {return 13;}
