...
public class BronzeLeaves extends BlockLeaves implements IHasModel
{
	public static String type;
	
	public BronzeLeaves(String name) 
	{
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.BRONZE_PINECONE, RANDOM.nextInt(6)+-4));
			if(RANDOM.nextFloat()>0.7f) {
				drops.add(new ItemStack(BlockInit.BRONZE_SAPLING, RANDOM.nextInt(6)+-4));
