...
public class GoldenLeaves extends BlockLeaves implements IHasModel
{
	public static String type;
	
	public GoldenLeaves(String name) 
	{
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.GOLDEN_PINECONE, RANDOM.nextInt(6)+-4));
			if(RANDOM.nextFloat()>0.7f) {
				drops.add(new ItemStack(BlockInit.GOLDEN_SAPLING, RANDOM.nextInt(6)+-4));
