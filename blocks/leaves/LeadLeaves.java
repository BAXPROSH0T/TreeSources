...
public class LeadLeaves extends BlockLeaves implements IHasModel
{
	public static String type;
	
	public LeadLeaves(String name) 
	{
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.LEAD_PINECONE, RANDOM.nextInt(6)+-4));
			if(RANDOM.nextFloat()>0.7f) {
				drops.add(new ItemStack(BlockInit.LEAD_SAPLNG, RANDOM.nextInt(6)+-4));
