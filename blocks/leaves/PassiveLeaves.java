...
public class PassiveLeaves  extends BlockLeaves implements IHasModel
{
	public static String type;
	
	public PassiveLeaves(String name) 
	{
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.PASSIVE_PINECONE, RANDOM.nextInt(6)+-4));
			if(RANDOM.nextFloat()>0.7f) {
				drops.add(new ItemStack(BlockInit.PASSIVE_SAPLING, RANDOM.nextInt(6)+-4));
