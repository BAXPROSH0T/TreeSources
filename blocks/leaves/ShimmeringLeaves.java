...
public class ShimmeringLeaves extends BlockLeaves implements IHasModel
{
	public static String type;
	
	public ShimmeringLeaves(String name) 
	{
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.SHIMMERING_PINECONE, RANDOM.nextInt(6)+-4));
			if(RANDOM.nextFloat()>0.7f) {
				drops.add(new ItemStack(BlockInit.SHIMMERING_SAPLING, RANDOM.nextInt(6)+-4));
