...
public class AluminumLogs extends BlockLog implements IHasModel
{
	public AluminumLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.ALUMINUM_SAP, RANDOM.nextInt(6)+-4));
