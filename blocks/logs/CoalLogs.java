...
public class CoalLogs extends BlockLog implements IHasModel
{
	public CoalLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.COAL_SAP, RANDOM.nextInt(6)+-4));
