...
public class CopperLogs extends BlockLog implements IHasModel
{
	public CopperLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.COPPER_SAP, RANDOM.nextInt(6)+-4));
