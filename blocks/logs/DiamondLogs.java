...
public class DiamondLogs extends BlockLog implements IHasModel
{
	public DiamondLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.DIAMOND_SAP, RANDOM.nextInt(6)+-4));
