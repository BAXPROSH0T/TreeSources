...
public class DirtLogs extends BlockLog implements IHasModel
{
	public DirtLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.DIRT_SAP, RANDOM.nextInt(6)+-4));
