...
public class EmeraldLogs extends BlockLog implements IHasModel
{
	public EmeraldLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.EMERALD_SAP, RANDOM.nextInt(6)+-4));
