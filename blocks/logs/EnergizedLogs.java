...
public class EnergizedLogs extends BlockLog implements IHasModel
{
	public EnergizedLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.ENERGIZED_SAP, RANDOM.nextInt(6)+-4));
