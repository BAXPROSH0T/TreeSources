...
public class GravelLogs extends BlockLog implements IHasModel
{
	public GravelLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.GRAVEL_SAP, RANDOM.nextInt(6)+-4));
