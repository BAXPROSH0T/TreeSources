...
public class HostileLogs extends BlockLog implements IHasModel
{
	public HostileLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.HOSTILE_SAP, RANDOM.nextInt(6)+-4));
