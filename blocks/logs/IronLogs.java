...
public class IronLogs extends BlockLog implements IHasModel
{
	public IronLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.IRON_SAP, RANDOM.nextInt(6)+-4));
