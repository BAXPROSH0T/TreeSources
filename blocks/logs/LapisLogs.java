...
public class LapisLogs extends BlockLog implements IHasModel
{
	public LapisLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.LAPIS_SAP, RANDOM.nextInt(6)+-4));
