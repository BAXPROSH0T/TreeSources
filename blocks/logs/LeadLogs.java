...
public class LeadLogs extends BlockLog implements IHasModel
{
	public LeadLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.LEAD_SAP, RANDOM.nextInt(6)+-4));
