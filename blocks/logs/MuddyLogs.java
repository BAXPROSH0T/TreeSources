...
public class MuddyLogs extends BlockLog implements IHasModel
{
	public MuddyLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.MUDDY_SAP, RANDOM.nextInt(6)+-4));
