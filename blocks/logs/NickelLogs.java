...
public class NickelLogs extends BlockLog implements IHasModel
{
	public NickelLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.NICKEL_SAP, RANDOM.nextInt(6)+-4));
