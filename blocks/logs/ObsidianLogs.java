...
public class ObsidianLogs extends BlockLog implements IHasModel
{
	public ObsidianLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.OBSIDIAN_SAP, RANDOM.nextInt(6)+-4));
