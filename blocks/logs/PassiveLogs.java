...
public class PassiveLogs extends BlockLog implements IHasModel
{
	public PassiveLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.PASSIVE_SAP, RANDOM.nextInt(6)+-4));
