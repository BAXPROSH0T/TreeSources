...
public class QuartzLogs extends BlockLog implements IHasModel
{
	public QuartzLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.QUARTZ_SAP, RANDOM.nextInt(6)+-4));
