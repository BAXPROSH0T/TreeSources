...
public class RockyLogs extends BlockLog implements IHasModel
{
	public RockyLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.ROCKY_SAP, RANDOM.nextInt(6)+-4));
