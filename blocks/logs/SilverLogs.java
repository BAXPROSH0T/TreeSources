...
public class SilverLogs extends BlockLog implements IHasModel
{
	public SilverLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.SILVER_SAP, RANDOM.nextInt(6)+-4));
