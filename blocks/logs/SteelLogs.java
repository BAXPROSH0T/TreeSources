...
public class SteelLogs extends BlockLog implements IHasModel
{
	public SteelLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.STEEL_SAP, RANDOM.nextInt(6)+-4));
