...
public class TinLogs extends BlockLog implements IHasModel
{
	public TinLogs(String name, Material materal)
	{	
	...
	public ArrayList<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState blockstate, int fortune){
			...
			drops.add(new ItemStack(ItemInit.TIN_SAP, RANDOM.nextInt(6)+-4));
