...
import com.bax.treesources.world.tree.WorldGenEmeraldTree;
...
public class EmeraldSapling extends BlockBush implements IGrowable, IHasModel
{
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
	{
		if (!net.minecraftforge.event.terraingen.TerrainGen.saplingGrowTree(worldIn, rand, pos))
			return;
		WorldGenerator worldgenerator = new WorldGenEmeraldTree(true);
		int i = 0;
		int j = 0;
		boolean flag = false;
