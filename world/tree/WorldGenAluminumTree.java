...
public class WorldGenAluminumTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.ALUMINUM_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.ALUMINUM_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenAluminumTree(boolean notify)
	{
		super(notify);
	}
