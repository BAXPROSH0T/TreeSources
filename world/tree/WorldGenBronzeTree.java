...
public class WorldGenBronzeTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.BRONZE_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.BRONZE_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenBronzeTree(boolean notify)
	{
		super(notify);
	}
