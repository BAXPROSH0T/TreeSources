...
public class WorldGenCoalTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.COAL_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.COAL_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));
