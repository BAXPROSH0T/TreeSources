...
public class WorldGenCopperTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.COPPER_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.COPPER_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenCopperTree(boolean notify)
	{
		super(notify);
	}
