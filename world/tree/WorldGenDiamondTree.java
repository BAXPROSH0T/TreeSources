...
public class WorldGenDiamondTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.DIAMOND_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.DIAMOND_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenDiamondTree(boolean notify)
	{
		super(notify);
	}
