...
public class WorldGenDirtTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.DIRT_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.DIRT_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenDirtTree(boolean notify)
	{
		super(notify);
	}
