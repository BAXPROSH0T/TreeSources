...
public class WorldGenEmeraldTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.EMERALD_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.EMERALD_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenEmeraldTree(boolean notify)
	{
		super(notify);
	}
