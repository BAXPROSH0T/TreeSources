...
public class WorldGenEnergizedTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.ENERGIZED_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.ENERGIZED_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenEnergizedTree(boolean notify)
	{
		super(notify);
	}
