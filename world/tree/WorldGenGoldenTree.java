...
public class WorldGenGoldenTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.GOLDEN_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.GOLDEN_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenGoldenTree(boolean notify)
	{
		super(notify);
	}
