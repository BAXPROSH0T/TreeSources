...
public class WorldGenGravelTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.GRAVEL_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.GRAVEL_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenGravelTree(boolean notify)
	{
		super(notify);
	}
