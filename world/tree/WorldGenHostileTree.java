...
public class WorldGenHostileTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.HOSTILE_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.HOSTILE_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenHostileTree(boolean notify)
	{
		super(notify);
	}
