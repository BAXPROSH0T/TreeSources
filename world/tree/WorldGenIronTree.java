...
public class WorldGenIronTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.IRON_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.IRON_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenIronTree(boolean notify)
	{
		super(notify);
	}
