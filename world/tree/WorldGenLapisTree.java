...
public class WorldGenLapisTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.LAPIS_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.LAPIS_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenLapisTree(boolean notify)
	{
		super(notify);
	}
