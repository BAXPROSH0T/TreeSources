...
public class WorldGenLeadTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.LEAD_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.LEAD_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenLeadTree(boolean notify)
	{
		super(notify);
	}
