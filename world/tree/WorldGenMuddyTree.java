...
public class WorldGenMuddyTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.MUDDY_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.MUDDY_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenMuddyTree(boolean notify)
	{
		super(notify);
	}
