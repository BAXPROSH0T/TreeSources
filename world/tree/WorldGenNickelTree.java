...
public class WorldGenNickelTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.NICKEL_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.NICKEL_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenNickelTree(boolean notify)
	{
		super(notify);
	}
