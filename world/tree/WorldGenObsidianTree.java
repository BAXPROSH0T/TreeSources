...
public class WorldGenObsidianTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.OBSIDIAN_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.OBSIDIAN_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenObsidianTree(boolean notify)
	{
		super(notify);
	}
