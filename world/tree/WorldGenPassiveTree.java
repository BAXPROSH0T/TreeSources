...
public class WorldGenPassiveTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.PASSIVE_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.PASSIVE_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenPassiveTree(boolean notify)
	{
		super(notify);
	}
