...
public class WorldGenQuartzTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.QUARTZ_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.QUARTZ_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenQuartzTree(boolean notify)
	{
		super(notify);
	}
