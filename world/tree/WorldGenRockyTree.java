...
public class WorldGenRockyTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.ROCKY_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.ROCKY_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenRockyTree(boolean notify)
	{
		super(notify);
	}
