...
public class WorldGenSandyTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.SANDY_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.SANDY_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenSandyTree(boolean notify)
	{
		super(notify);
	}
