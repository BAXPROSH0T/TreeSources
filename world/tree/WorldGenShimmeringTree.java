package com.bax.treesources.world.tree;
...
public class WorldGenShimmeringTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.SHIMMERING_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.SHIMMERING_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenShimmeringTree(boolean notify)
	{
		super(notify);
	}
