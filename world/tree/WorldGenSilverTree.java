...
public class WorldGenSilverTree extends WorldGenAbstractTree {
	...
	private static final IBlockState LOG = BlockInit.SILVER_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.SILVER_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenSilverTree(boolean notify)
	{
		super(notify);
	}
