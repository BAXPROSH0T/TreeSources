...
public class WorldGenSteelTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.STEEL_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.STEEL_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenSteelTree(boolean notify)
	{
		super(notify);
	}
