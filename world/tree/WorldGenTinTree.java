...
public class WorldGenTinTree extends WorldGenAbstractTree {

	private static final IBlockState LOG = BlockInit.TIN_LOGS.getDefaultState();
	private static final IBlockState LEAF = BlockInit.TIN_LEAVES.getDefaultState().withProperty(DirtLeaves.CHECK_DECAY, Boolean.valueOf(false));

	public WorldGenTinTree(boolean notify)
	{
		super(notify);
	}
